...
incsrc "Resources.asm"

print "SpriteNumberToGraphics: $", hex(SpriteNumberToGraphics)

print "Resource0: $", hex(Resource0)
print "Resource0_RSRC0: $", hex(Resource0_RSRC0)

print "Resource1: $", hex(Resource1)
print "Resource1_RSRC0: $", hex(Resource1_RSRC0)